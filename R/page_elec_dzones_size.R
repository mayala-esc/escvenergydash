            ...
            fluidRow(
              column(
                ...
                shinycssloaders::withSpinner(
                  highchartOutput("vec_elec_mktsize_lrg", height = 500),
                  type = 1,
                  color = "#023047"
                )
              )
        ...
        shiny::fluidRow(
          ...
          shiny::column(
            ...
            shinyWidgets::radioGroupButtons(
              inputId = "cust_type_elec_mktsize_lrg",
              status = "secondary",
              label = "Customer Type",
            ...
            ,
            shinyWidgets::radioGroupButtons(
              inputId = "elec_dist_zones_mktsize_lrg",
              status = "secondary",
          ...
          div(
            ...
            fluidRow(
              column(
                12,
                shinycssloaders::withSpinner(
                  highchartOutput("vec_elec_mktsize_med", height = 500),
                  type = 1,
                  color = "#023047"
                )
              )
      ...
      shinydashboard::box(
        ...
        shiny::fluidRow(
          ...
          shiny::column(
            ...
            # chart option selector
            shinyWidgets::radioGroupButtons(
              inputId = "cust_type_elec_mktsize_med",
              status = "secondary",
              label = "Customer Type",
              choices = c("Residential" = "res", "Small business" = "sme"),
              selected = "res",
            ...
            ,
            shinyWidgets::radioGroupButtons(
              inputId = "elec_dist_zones_mktsize_med",
              status = "secondary",
              label = "Distribution Zone",
              choices = c(
                "Jemena" = "jemena",
          ...
          div(
            ...
            fluidRow(
              column(
                12,
                shinycssloaders::withSpinner(
                  highchartOutput("vec_elec_mktsize_sml", height = 500),
                  type = 1,
                  color = "#023047"
                )
              )
      ...
      shinydashboard::box(
        ...
        shiny::fluidRow(
          ...
          shiny::column(
            ...
            # chart option selector
            shinyWidgets::radioGroupButtons(
              inputId = "cust_type_elec_mktsize_sml",
              status = "secondary",
              label = "Customer Type",
              choices = c("Residential" = "res", "Small business" = "sme"),
              selected = "res",
            ...
            ,
            shinyWidgets::radioGroupButtons(
              inputId = "elec_dist_zones_mktsize_sml",
              status = "secondary",
              label = "Distribution Zone",
              choices = c(
                "Jemena" = "jemena",
