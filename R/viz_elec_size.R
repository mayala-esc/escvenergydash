...
highcharts_elec_size <- function(
  ...
  title <-  paste0("Median Electricity Offers Annual Bill - ", stringr::str_to_sentence(customer))
  ...
  highchart(type = "stock") %>%
    ...
    # custom exporting
    format_export(
      filename = paste("ESC_electricity_offers", customer, dist_zone, sep = "_")
    ) %>%
