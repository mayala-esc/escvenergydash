            ...
            fluidRow(
              column(
                ...
                shinycssloaders::withSpinner(
                  highchartOutput("vec_elec_size_res", height = 500),
                  type = 1,
                  color = "#023047"
                )
              )
        ...
        shiny::fluidRow(
          ...
          shiny::column(
            ...
            shinyWidgets::radioGroupButtons(
              inputId = "elec_dist_zones_size_res",
              status = "secondary",
          ...
          div(
            ...
            fluidRow(
              column(
                12,
                shinycssloaders::withSpinner(
                  highchartOutput("vec_elec_size_sme", height = 500),
                  type = 1,
                  color = "#023047"
                )
              )
      ...
      shinydashboard::box(
        ...
        shiny::fluidRow(
          ...
          shiny::column(
            ...
            shinyWidgets::radioGroupButtons(
              inputId = "elec_dist_zones_size_sme",
              status = "secondary",
              label = "Distribution Zone",
              choices = c(
                "Jemena" = "jemena",
