...
page_gas_noffersUI <- function(...){
  ...
  shiny::fluidPage(
    ...
    "Number of new offers released to the market" %>%
      h2() %>% div(class = "inner") %>%
            ...
            fluidRow(
              column(
                ...
                shinycssloaders::withSpinner(
                  highchartOutput("vec_gas_noffers", height = 500),
                  type = 1,
                  color = "#023047"
                )
              )
    ...
    "Percent of new offers released to the market" %>%
      h2() %>% div(class = "inner") %>%
      div(class = "small-box") %>% column(12, .) %>%
      fluidRow(),
          ...
          div(
            ...
            fluidRow(
              column(
                12,
                shinycssloaders::withSpinner(
                  highchartOutput("vec_gas_noffers_pcent", height = 500),
                  type = 1,
                  color = "#023047"
                )
              )
